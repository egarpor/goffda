...
[![Travis build status](https://travis-ci.org/egarpor/goffda.svg?branch=master)](https://travis-ci.org/egarpor/goffda)
[![CRAN status](https://www.r-pkg.org/badges/version/goffda)](https://cran.r-project.org/package=goffda)
<!-- badges: end -->
